...
| **3. Abstract (70%)** | (1) Abstract covers all key components: background, aim or problem statement, methods, results, and conclusions, with a significance statement at the end; abstract is concise, structured, and standalone; abstract on longer than 250 words. (2) Abstract is mostly complete but lacks depth in one or more components, such as aim, results, or significance; abstract exceeding/falling short of word limits. (3) Abstract is incomplete, disorganized, or missing key components such as methods or significance. | 
