...
* Note: With respect to novelty statement, in this course, we do not expect novel research. If your research is not novel, simply focus on highlighting the practical significance, relevance, or application of your work. Emphasize how your study addresses a gap, applies existing methods in a new context, or reinforces established findings. The goal is to demonstrate clarity and thoughtful engagement with the topic rather than originality.
